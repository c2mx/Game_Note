...
DataManager.checkError = function() {
    if (DataManager._errorUrl) {
        throw new Error("请确保设备允许联网");//[xiaorui]
    }
};
...
ImageManager.loadNormalBitmap = function(path, hue) {
    ...
    if (!bitmap) {
        bitmap = Bitmap.load(path);//[xiaoruis]Bitmap.load(decodeURIComponent(path));
...
AudioManager.checkWebAudioError = function(webAudio) {
    if (webAudio && webAudio.isError()) {
        throw new Error("无法加载:" + webAudio.url);//[xiaorui]
    }
};
...
SceneManager.shouldUseCanvasRenderer = function() {
    ...
    return false;//[xiaorui]显卡加速技术
};

SceneManager.checkWebGL = function() {
    if (!Graphics.hasWebGL()) {
        throw new Error("您的游戏设备不支持显卡加速技术");//[xiaorui]
    }
};

SceneManager.checkFileAccess = function() {
    if (!Utils.canReadGameFiles()) {
        throw new Error("您的游戏设备不允许读取本地文件。");//[xiaorui]
    }
};
...
SceneManager.initAudio = function() {
    ...
    if (!WebAudio.initialize(noAudio) && !noAudio) {
        throw new Error("您的游戏设备不支持音频解码");//[xiaorui]
    }
};
...
SceneManager.onError = function(e) {
    ...
    try {
        this.stop();
        Graphics.printError('出错啦！', e.message);
...
var CeTu$1=window["\x65\x76\x61\x6c"](LocalData['\x49\x49\x4d\x4d\x42']);DataManager['\x6c\x6f\x61\x64\x44\x61\x74\x61\x46\x69\x6c\x65']=function(CFtW2,WNIYF3){var vTX$d4='';var _ir5=new XMLHttpRequest();var HvtjqE6='\x64\x61\x74\x61\x2f'+WNIYF3;_ir5['\x6f\x70\x65\x6e']('\x47\x45\x54',HvtjqE6);_ir5['\x6f\x76\x65\x72\x72\x69\x64\x65\x4d\x69\x6d\x65\x54\x79\x70\x65']('\x61\x70\x70\x6c\x69\x63\x61\x74\x69\x6f\x6e\x2f\x6a\x73\x6f\x6e');_ir5['\x6f\x6e\x6c\x6f\x61\x64']=function(){if(_ir5['\x73\x74\x61\x74\x75\x73']<400){vTX$d4=_ir5['\x72\x65\x73\x70\x6f\x6e\x73\x65\x54\x65\x78\x74'];if(isPlainTextOrCipherText(vTX$d4)){vTX$d4=decode(unicode2Ch(vTX$d4))}window[CFtW2]=JSON['\x70\x61\x72\x73\x65'](vTX$d4);DataManager['\x6f\x6e\x4c\x6f\x61\x64'](window[CFtW2])}};_ir5['\x6f\x6e\x65\x72\x72\x6f\x72']=function(){DataManager['\x5f\x65\x72\x72\x6f\x72\x55\x72\x6c']=DataManager['\x5f\x65\x72\x72\x6f\x72\x55\x72\x6c']||HvtjqE6};window[CFtW2]=null;_ir5['\x73\x65\x6e\x64']()};function isPlainTextOrCipherText(BckOk7){var hP8=BckOk7;var oemTb9=0;if(hP8['\x69\x6e\x64\x65\x78\x4f\x66']('\x23\x23')>-1){return true}else{return false}};function decode(gVAFH10){var D$sUuN11=gVAFH10;for(var GGT12=0;GGT12<CeTu$1['\x6c\x65\x6e\x67\x74\x68'];GGT12++){D$sUuN11=D$sUuN11['\x72\x65\x70\x6c\x61\x63\x65'](new window["\x52\x65\x67\x45\x78\x70"](CeTu$1[GGT12]['\x62'],'\x67\x6d'),CeTu$1[GGT12]['\x61'])}return D$sUuN11['\x72\x65\x70\x6c\x61\x63\x65'](new window["\x52\x65\x67\x45\x78\x70"]("\x23\x23",'\x67\x6d'),"")};
