...
Sprite_Destination.prototype.createBitmap = function() {
    ...
    this.bitmap.fillAll('yellow');//[xiaorui]
    this.anchor.x = 0.5;
    this.anchor.y = 0.5;
    this.blendMode = Graphics.BLEND_ADD;
};
...
Sprite_Destination.prototype.updateAnimation = function() {
    this._frameCount++;
    this._frameCount %= 30;//闪动速率20[xiaorui]
    this.opacity = (20 - this._frameCount) * 4;//透明度6[xiaorui]
    this.scale.x = 0.5 + this._frameCount / 80;//大小1+20[xiaorui]
