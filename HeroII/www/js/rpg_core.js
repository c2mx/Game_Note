...
Graphics._cssFontLoading = false;//apk报错[xiaorui]
...
Graphics.initialize = function(width, height, type) {
    this._width = width || 960;//800[xiaorui]
    this._height = height || 541;//600[xiaorui]
...
Graphics.printLoadingError = function(url) {
    if (this._errorPrinter && !this._errorShowed) {
        this._errorPrinter.innerHTML = this._makeErrorHtml('加载失败', '没有找到: ' + url);
        var button = document.createElement('button');
        button.innerHTML = '忽略错误';
        ...
        button.style.boxShadow = '1px 1px 5px #8f8c8c';
...
function KWKK(){
    ...
    SessionData.KWKK=(size/1024).toFixed(2)
}

Graphics._makeErrorHtml = function(name, message) {
        KWKK();
        return ('<font color="yellow" style="font-size: 31px;font-family: GameFont"><b>' +"进入武林时发生错误"+ '</b></font><br>' +
        '<font color="white" style="font-size: 14px;font-family: GameFont">' +"["+name+"]："+ message +'</font><br>' +
        '<font color="white" style="font-size: 14px;font-family: GameFont">'+"建档:" +"["+$gameVariables.value(293)+"]·"+"版本:"+"["+LocalData.localvs+"]·"+"网络:"+"["+SessionData.opengame+"]·"+"设备:"+"["+LocalData.device+"]·"+"状态:"+"["+LocalData.HEROIIVIP+"]·"+"["+SessionData.KWKK+" KB"+"]·"+"["+LocalData.IImoneyALL+"]"+'</font><br>');
};//报错反馈[xiaorui]
...
Decrypter.readEncryptionkey = function(){
    this._encryptionKey = decode(localStorage.getItem("Fmii")).split(/(.{2})/).filter(Boolean);
};//[xiaorui]
