...
(function() {
    ...
    Window_EnemyBookIndex.prototype.initialize = function(x, y) {
        ...
        var height = this.fittingHeight(4);//xiaorui
    ...
    Window_EnemyBookStatus.prototype.initialize = function(x, y, width, height) {
        ...
        this._enemySprite.x = width / 2 + 35;
        this._enemySprite.y = height / 4;
    ...
    Window_EnemyBookStatus.prototype.update = function() {
        ...
        if (this._enemySprite.bitmap) {
            ...
            this._enemySprite.scale.x = scale*1.3;//xiaorui
            this._enemySprite.scale.y = scale*1.3;//xiaorui
        }
    };
    ...
    Window_EnemyBookStatus.prototype.refresh = function() {
        ...
        this.resetTextColor();
        this.drawText(enemy.name, x+70, y);//xiaorui
        ...
        x = this.contents.width - rewardsWidth +100;
        y = lineHeight + this.textPadding();

        this.resetTextColor();
        this.drawText(enemy.gold, x, y);
        x += this.textWidth(enemy.gold) + 16;
        this.changeTextColor(this.systemColor());
        ...
        this.changeTextColor(this.systemColor());
        this.drawText("位置：", x-140, y-80 + lineHeight * 0, descWidth);
        this.drawText("防盗能力：", x-140, y-80 + lineHeight * 2, descWidth);
        this.resetTextColor();
        this.drawTextEx(enemy.meta.desc1, x-75, y-76 + lineHeight * 0, descWidth);
        this.drawTextEx(enemy.meta.desc2, x-30, y-76 + lineHeight * 2, descWidth);
    };
