...
Window_ItemCategory.prototype.windowWidth = function() {
    if (SceneManager._scene instanceof Scene_Item) return 280;
    return Yanfly.Item.Window_ItemCategory_windowWidth.call(this);//xiaorui
};
...
Window_ItemCategory.prototype.numVisibleRows = function() {
    ...
    return Yanfly.Item.Window_ItemCategory_numVisibleRows.call(this);//xiaorui
};

Yanfly.Item.Window_ItemCategory_maxCols = Window_ItemCategory.prototype.maxCols;
Window_ItemCategory.prototype.maxCols = function() {
    if (SceneManager._scene instanceof Scene_Item) return 3;
    return Yanfly.Item.Window_ItemCategory_maxCols.call(this);//xiaorui
};
...
Window_ItemList.prototype.maxCols = function() {
    if (SceneManager._scene instanceof Scene_Item) return 2;//列表列数xiaorui
