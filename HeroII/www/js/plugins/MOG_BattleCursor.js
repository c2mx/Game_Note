...
/*:
 * @plugindesc (v2.1) Adiciona flechas de indicação nos alvos selecionados.
 * @author Moghunter
 *
 * @param X-Axis
...
//==============================
// * Refresh Arrow Name [敌人名字显示]
//==============================
BattleCursor.prototype.refresh_arrow_name = function(battler,sprite) {
	battler._refCursor = false;
	sprite.opacity = 255;
	sprite.bitmap.clear();
	if($gameSwitches.value(718)==true) {
		sprite.bitmap.drawText($gameVariables.value(653),0,0,120,32,"center");
	}
	else{
