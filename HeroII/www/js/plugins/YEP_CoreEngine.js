...
Game_Actor.prototype.paramMax = function(paramId) {
    if($gameSwitches.value(639)==true){
        if (paramId === 0) {
            return 85000;//[xiaoruis]Yanfly.Param.ActorMaxHp
        } else if (paramId === 1) {
            return 27500;//Yanfly.Param.ActorMaxMp
        } else {
            return 3850;//Yanfly.Param.ActorParam
        }
    }else{
        if (paramId === 0) {
            return 27500;//Yanfly.Param.ActorMaxHp
        } else if (paramId === 1) {
            return 18500;//Yanfly.Param.ActorMaxMp
        } else {
            return 840;//Yanfly.Param.ActorParam
        }
    }
};
