...
Window_StatusInfo.prototype.drawGeneral = function() {
		...
		this.drawText("年龄："+$gameVariables.value(15)+" 岁", dx-60, dy, dw, 'center');
        switch (parseInt($gameVariables.value(17))){
         case 1:
          this.changeTextColor(this.deathColor());
          this.drawText("[男]", dx+80, dy, dw, 'center');
          break;
         case 2:
          this.changeTextColor(this.deathColor());
          this.drawText("[女]", dx+80, dy, dw, 'center');
          break;
         case 3:
          this.changeTextColor(this.hpGaugeColor1());
          this.drawText("[已自宫]", dx+60, dy, dw, 'center');
          break;
         default:
          this.changeTextColor(this.hpGaugeColor1());
          this.drawText("[未知]", dx+70, dy, dw, 'center');
        }
		dx += this.contents.width / 2;
        this.changeTextColor(this.tpGaugeColor2());
        this.drawText($gameActors._data[14]._nickname, dx-220, dy, dw, 'center');
        this.changeTextColor(this.systemColor());
        this.drawText($gameActors._data[1]._nickname, dx-20, dy, dw, 'center');
