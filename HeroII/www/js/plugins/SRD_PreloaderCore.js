...
Scene_Preload.prototype.createSubtitle = function() {
	this._subHeight = Graphics.boxHeight / 42;
	this._subtitle = new Sprite(new Bitmap(Graphics.boxWidth/1.21, this._subHeight));
	this._subtitle.y +=488;
	this._subtitle.x +=27;
...
Scene_Preload.prototype.refreshSubtitle = function() {
	...
	this._subtitle.bitmap.fillRect(0, 0, Graphics.boxWidth/1.21 * rate, this._subHeight, _.mainColor);
};
...
Scene_Preload.prototype.updateAudio = function() {
	...
	if(audio) {
		...
		this._subtitle.bitmap.drawText(value, -80, 0, Graphics.boxWidth, this._subHeight, 'center');
	}
	this._curIndex++;
...
Scene_Preload.prototype.gotoWaitPhase = function() {
	...
	this.refreshSubtitle();
	this._subtitle.bitmap.drawText(_.complete, -65, 0, Graphics.boxWidth, this._subHeight, 'center');//���
	this._curIndex = 30;
};
