...
Window_FishInfo.prototype.type = function() {
	...
	this.drawText(t, -10, 0, this.contents.width,'right');
	this.changeTextColor(this.systemColor());
...
Window_FishStatus.prototype.setItem = function(item) {
	...
	if (item) {
		...
		this.resetTextColor();
		this.drawText(item.amount,-10,y - line * 2,this.contents.width,'right'); // Amount
		this.drawText(item.length,-10,y - line,this.contents.width,'right');  // Length
		this.drawText(item.weight,-10,y,this.contents.width,'right');  // Weight
