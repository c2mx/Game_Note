...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_SceneFile');
	...
	Moghunter.scFile_CursorS = Number(Moghunter.parameters['File Space'] || 60);
...
Scene_File.prototype.updateCursor = function() {
     var nx = Moghunter.scFile_CursorX + (Moghunter.scFile_CursorS * this._listWindow._index)-15;
...
Scene_File.prototype.nextIndex = function(value) {
	 ...
	 if (this._listWindow._index < 0) {this._listWindow._index = 7};
	 if (this._listWindow._index > 7) {this._listWindow._index = 0};
}; 
