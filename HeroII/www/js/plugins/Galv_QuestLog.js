...
Galv.QUEST.file.getString = function(filePath) {
	...
	request.open("GET", filePath,charset="gb2312");
...
Galv.QUEST.txtCmdcancel = PluginManager.parameters('Galv_QuestLog')["cancel Cmd Txt"];//[xiaoruis]
...
Window_QuestCategory.prototype.makeCommandList = function() {
	...
	this.addCommand(Galv.QUEST.txtCmdcancel, 'cancel');//新增加一个取消返回按钮[xiaoruis]
