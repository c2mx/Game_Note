...
Scene_Gobang.prototype.createBackgroud = function(){
	this._BGSprite = new Sprite(ImageManager.loadGobang('UI'));
	this._BGSprite.x = 480;
	this._BGSprite.y = 268;
	this.adBGSprite(this._BGSprite);
	this.addChild(this._BGSprite);

}

Scene_Gobang.prototype.adBGSprite = function(sprite) {
	sprite.scale.x = this._scale*1.55;
	sprite.scale.y = this._scale*1.55;
	sprite.anchor.x = 0.5;
	sprite.anchor.y = 0.5;
};
