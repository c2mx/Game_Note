...
Scene_PicMatch.prototype.createBG = function(){
	var height = Graphics.boxHeight * 0.5;
	var width = this._width;
	this._MessageSprite = new Sprite(ImageManager.loadPicMatch("UIBG"));
	this._MessageSprite.x = width / 2+359;
	...
	this._MessageSprite.scale.x = scale*1.56;
	this._MessageSprite.scale.y = scale*1.56;
